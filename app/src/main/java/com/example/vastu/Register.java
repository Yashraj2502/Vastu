 ...
 * Registration form
 *
 * Registering users suing Firebase auth and cloud storage
 *
 */
...
public class Register extends AppCompatActivity {
    ...
    String userID; // Used for Firebase user id
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Checking if there is user already exists
        ...
        // Button for already registered user to redirect
